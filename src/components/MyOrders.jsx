...
export default function MyOrders() {
  ...
  <div className=" flex">
    <div className=" p-10 cursor-pointer hover:bg-slate-400" onClick={()=>setMode("MYORDER")}>
      <h1>MYORDER</h1>
    </div>
    <div className=" p-10 cursor-pointer hover:bg-slate-400" onClick={()=>setMode("MYSALE")}>
      <h1>MYSALE</h1>
    </div>
  </div>
  <div className="">
